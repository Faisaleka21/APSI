...
<?php
    if (isset($_POST['username'])) {
        ...
        if (mysqli_num_rows($cek) > 0) {
            ...
            $query = mysqli_query($koneksi, "INSERT INTO user(username,password,Email) VALUES ('$username','$password','$Email')");
            if ($query) {
...
<head>
    <meta charset="UTF-8">
    <title>FurniSpace | Register</title>
...
<body>
    <div class="login-container">
        ...
        <div class="login-footer">
            <p>Sudah punya akun? <a href="loginUser.php" >Login</p>
        </div>
    </div>
