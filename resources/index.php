...
<header role="banner">
  <div class="container header-inner">
    ...
    <a class="logo" aria-label="Furnispace homepage" href="index.php" style="text-decoration: none;">
    ...
    <button class="icon-button" aria-label="View shopping cart" onclick="window.location.href='loginUser.php';">
    ...
    <div style="position: relative; display: inline-block;">
      ...
      <div id="profileDropdown" style="display: none; position: absolute; right: 0; top: 48px; background: #fffde7; box-shadow: 0 4px 16px rgba(251,192,45,0.18); border-radius: 12px; min-width: 260px; z-index: 200; padding: 20px;">
        ...
        <a href="loginUser.php" style="display: block; text-align: center; color: #d84315; font-weight: 600; text-decoration: none; padding: 8px 0; border-radius: 6px; background: #fff3e0;">Login</a>
      </div>
    </div>
    <script>
